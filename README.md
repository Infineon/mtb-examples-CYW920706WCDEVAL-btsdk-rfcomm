...
- spp:
    - Sample app demonstrating Serial Port Profile (SPP).
- spp_multi_port:
    - SPP sample app that supports up to two SPP connections and interfaces to an external host using WICED HCI to send and receive data.
- pbap_client:
    - Sample app demonstrating Phonebook Client Profile.
- map_client:
    - Sample app demonstrating Message Access Client Profile.
